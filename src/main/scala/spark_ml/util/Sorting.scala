...
// This fixes the Scala quickSort bug for 2.9.2
// The custom Ordering[K] version was using '==' to compare two elements.
// However, '==' is not defined for a custom ordering, and instead 'equiv' should be used.
